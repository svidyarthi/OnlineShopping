...
try {
		...
		if(securityManager.updateProfile(a)==false){
			servletResponse.sendRedirect("/AdminApp/MyProfile.html?email="+email+"&result=false");
		}
		else{
		servletResponse.sendRedirect("/AdminApp/MyProfile.html?email="+email+"&result=true");
		}
